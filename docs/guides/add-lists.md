...
## Creating a basic list in a separate file
...
Here we described a very basic schema of a generic ToDo. Let's register it.
...
Tasks usually have a few more fields. Let's add the ability to set deadlines and the ability to add an assignee to a task:
...
Relaunch your app and check if you are able to create users through the GraphQL interface.
